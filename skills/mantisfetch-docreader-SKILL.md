...
| `429 uploads being received are holding N bytes`   | Other uploads still arriving already take the byte budget; this one was refused before any of it was read | Wait the seconds in `Retry-After`, then resend the whole request. Nothing was stored |
